...
**Struts2** 好处是不用考虑线程安全问题；**Servlet** 和 **SpringMVC** 需要考虑线程安全问题，但是性能可以提升，不用处理太多的 gc，可以**使用 ThreadLocal 来处理多线程**的问题。
...
- **volatile**、**Happens-Before 规则**可以解决有序性问题
...
![](https://gitee.com/xk39/typora-imgs/raw/master/imgs/Java并发和多线程-0001.png)
...
![](https://gitee.com/xk39/typora-imgs/raw/master/imgs/Java并发和多线程-0002.png)
...
![](https://gitee.com/xk39/typora-imgs/raw/master/imgs/Java并发和多线程-0003.png)
...
**synchronized**优化**简答**：在 Java 早期版本中，synchronized属于重量级锁，效率低下；在 Java 6 之后优化 synchronized 的实现方式，使用了偏向锁升级为轻量级锁再升级到重量级锁的方式，从而减低了锁带来的性能消耗。

**synchronized**优化**详答**：在 Java 早期版本中，synchronized属于重量级锁，效率低下，因为监视器锁（monitor）是依赖于底层的操作系统的 Mutex Lock 来实现的，Java 的线程是映射到操作系统的原生线程之上的。如果要挂起或者唤醒一个线程，都需要操作系统帮忙完成，而操作系统实现线程之间的切换时需要从用户态转换到内核态，这个状态之间的转换需要相对比较长的时间，时间成本相对较高，这也是为什么早期的 synchronized 效率低的原因。庆幸的是在 Java 6 之后 Java 官方从 JVM 层面对synchronized 进行较大优化，所以现在的 synchronized 锁效率也优化得很不错了。JDK1.6对锁的实现引入了大量的优化，如自旋锁、适应性自旋锁、锁消除、锁粗化、偏向锁、轻量级锁等技术来减少锁操作的开销。
...
![](https://gitee.com/xk39/typora-imgs/raw/master/imgs/Java并发和多线程-0004.png)
...
![](https://gitee.com/xk39/typora-imgs/raw/master/imgs/Java并发和多线程-0005.png)
...
![](https://gitee.com/xk39/typora-imgs/raw/master/imgs/Java并发和多线程-0006.png)
...
![](https://gitee.com/xk39/typora-imgs/raw/master/imgs/Java并发和多线程-0007.png)
...
![](https://gitee.com/xk39/typora-imgs/raw/master/imgs/Java并发和多线程-0008.png)
...
![](https://gitee.com/xk39/typora-imgs/raw/master/imgs/Java并发和多线程-0009.png)
